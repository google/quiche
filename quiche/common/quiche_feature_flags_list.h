...
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_ack_ce_immediately, false, true, "When true, acks a CE-marked packet immediately, unless the previous packet was also CE-marked.")
...
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_avoid_nested_close_connection, true, true, "If true, if QuicConnection::CloseConnection triggers a nested call to itself, make the nested call a no-op.")
...
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_dispatcher_only_serialize_close_if_closed_by_self, false, true, "If true, QuicDispatcher::CleanUpSession only serializes a connection close if the connection is closed by self, did not complete handshake and does not have termination packets.")
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_ecn_in_first_ack, true, true, "When true, reports ECN in counts in the ACK of the a client initial that goes in the buffered packet store.")
...
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_parse_transport_parameters_from_chlo, false, true, "If true, parse QUIC transport parameters from received CHLOs.")
