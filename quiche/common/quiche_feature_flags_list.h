...
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_allow_flow_label_blackhole_avoidance_on_server, false, false, "Change the flow label on the server side and attempt repathing to avoid blackhole.")
...
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_enobufs_blocked, false, true, "If true, ENOBUFS socket errors are reported as socket blocked instead of socket failure.")
...
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_least_unacked_plus_1, false, true, "If true, sets peer_least_packet_awaiting_ack to one more than the highest confirmed acknowledgment to fix an off-by-one error.")
...
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_use_inlining_send_buffer2, false, true, "Uses an inlining version of QuicSendStreamBuffer.")
