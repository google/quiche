...
// clang-format off
// DO NOT EDIT.
// Generated by:  blaze build gfe/gfe2:quic_feature_flags_list
...
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_always_send_version_negotiation, true, "If true, let GFE always send version negotiation when receiving packets with unsupported versions.")
...
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_track_tcp_stats_delta_at_session, false, "If true, computes the delta of TcpStats at session instead of FdWrapper in QUIC.")
...
QUICHE_FLAG(bool, quiche_restart_flag_quic_load_siphash_params, false, "When true, QUIC pulls the SipHash params from eBPF.")
...
QUICHE_FLAG(bool, quiche_restart_flag_quic_request_unroutable_cid, false, "When true, QUIC connections can request an unroutable connection ID because the load balancer is misconfigured.")
