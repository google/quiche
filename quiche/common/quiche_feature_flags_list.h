...
QUICHE_FLAG(bool, quiche_reloadable_flag_http2_avoid_decompose_representation, false, true, "If true, HPACK encoding will use a different iteration method that avoids unnecessary copies and string splitting.")
...
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_bbr_exit_startup_on_loss, false, true, "Enables negotiation of a connection option (B1AL) that lets BBRv1 exit STARTUP if a large number of packets was lost even if there is no non-app-limited sample.")
...
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_enable_5aff_connection_option, true, true, "If true, allows QUIC's 5AFF connection option to increase the amplication factor to 5.")
...
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_not_instantiate_unused_qpack_send_stream, false, true, "When qpack_maximum_dynamic_table_capacity is zero, don't bother to instantiate the unused QpackSendStream.")
