...
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_delay_connection_close_on_invalid_sni, false, true, "Delay closing the connection on invalid SNI in client hello till after the transport parameters are parsed.")
