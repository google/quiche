...
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_enforce_immediate_goaway, false, false, "If true, QUIC will support sending immediate GOAWAYS and will refuse streams above the limit.")
