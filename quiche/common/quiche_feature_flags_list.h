...
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_bbr2_enable_bbpd_by_default, false, false, "If true, QUIC BBR2 will use a 0.91 PROBE_DOWN gain by default.")
...
QUICHE_FLAG(bool, quiche_reloadable_flag_quic_better_qpack_compression, true, true, "If true, use improved QPACK compression algorithm.")
...
QUICHE_FLAG(bool, quiche_restart_flag_quic_opport_bundle_qpack_decoder_data5, true, true, "If true, bundle qpack decoder data with other frames opportunistically.")
